...
function update(){
  ...
  for (var i = 0; i < coins.length; i++) {
    ...
    if(dir === "l" || dir === "r"){
      window.location = 'scoleeruitkomsten.html';
    }
    if(dir === "b"){
      window.location = 'scoleeruitkomsten.html';
    }
    ...
    if(dir === "l" || dir === "r"){
      window.location = 'uexleeruitkomsten.html';
    }
    if(dir === "b"){
      window.location = 'uexleeruitkomsten.html';
    }
    ...
    if(dir === "l" || dir === "r"){
      window.location = 'devleeruitkomsten.html';
    }
    if(dir === "b"){
      window.location = 'devleeruitkomsten.html';
    }
